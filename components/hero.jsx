        ...
        <div className="flex flex-col items-center justify-center py-20 h-full">
          ...
          <div className="flex flex-col items-center mt-8 max-w-3xl w-11/12 md:w-full">
            <h1 className="text-4xl md:text-5xl lg:text-5xl md:!leading-snug font-semibold text-center bg-clip-text bg-gradient-to-b from-gray-50 to-gray-50 text-transparent">
              Create exceptional experiences with AI
            </h1>
            <p className="text-base md:text-lg text-foreground/80 mt-6 text-center">
              Transform your text into engaging videos with our AI-powered
              generator. Create stunning visuals effortlessly and captivate your
